  ...
  private initializeKnowledgeBase(): void {
    const entries: KnowledgeEntry[] = [
      ...
      // PROFESSIONAL CREDENTIALS AND BACKGROUND
      {
        ...
        userRoles: ['student', 'teacher', 'parent', 'professional'],
        content: {
          general: "I'm Dr. Scott I-Patrick DEdPsych BSc CPsychol MBPSs, a qualified Chartered Child and Adolescent Educational Psychologist with over 20 years of experience in education and 12+ years specialising in Educational Psychology. I'm registered with the Health and Care Professions Council (HCPC) under registration number PYL042340, which ensures I meet the highest professional standards and ethical requirements.",
