...
// Theme provider component with both names for compatibility
export function ThemeProvider({
  ...
  const applyBrandColorPalette = (
    ...
    const ageGroupAdjustments: Record<AgeGroup, Record<string, string>> = {
      'nursery': {
...
// For compatibility with components using @/components/theme-provider
export const AccessibilityContext = ThemeProviderContext;
export const useAccessibility = useTheme;